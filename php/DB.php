...
require_once 'system/DBConexion.php';
DBConexion::load();
DB::$user=DBConexion::$params['user'];
DB::$password=DBConexion::$params['password'];
DB::$host=DBConexion::$params['host'];
DB::$port=DBConexion::$params['port'];
...
class DB {
    ...
    public static $host = '';
    public static $port = null; //hhvm complains if this is null
